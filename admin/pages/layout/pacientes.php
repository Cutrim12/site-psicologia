            ...
            <div>
              <table class="table table-hover text-center">
                ...
                <tbody>
                  ...
                  $sql = "SELECT pa.id, pa.ativo, pa.nome, pa.cpf, pa.nascimento, c.celular, tp.tipo 
                  FROM tbl_paciente pa 
                  INNER JOIN tbl_contato c ON pa.id_contato = c.id 
                  ...
                  ?>
                    <tr>
                      <td><span style="color: <?php echo $row['ativo'] ? '#198754' : '#dc3545'; ?>; font-weight: bold;"><?php echo $row['ativo'] ? '✔' : '✘'; ?></span></td>
      ...
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title" id="exampleModalLabel" style="font-weight:bold;font-size:140%;">INATIVAR PACIENTE</h5>
