...
<head>
  ...
  <!-- Bootstrap -->
  <link rel="shortcut icon" href="../../../img/favicon.ico" rel="icon">
        ...
        <ul class="sidebar-menu">
          ...
          <li class="treeview">
            ...
            <ul class="treeview-menu">
              <li><a href="cadastro/cadastrar-paciente-adulto.php"><i class="fa fa-male"></i> Adulto</a></li>
              <li><a href="cadastro/cadastrar-paciente-crianca.php"><i class="fa fa-child"></i> Criança</a></li>
            </ul>
          </li>
          <li class="treeview active">
            ...
            <ul class="treeview-menu">
              <li><a href="pacientes.php"><i class="fa fa-users"></i> Pacientes</a></li>
              <li><a href="professores.php"><i class="fa fa-users"></i> Professores</a></li>
              <li class="active"><a href="terapeutas.php"><i class="fa fa-users"></i> Estagiários</a></li>
            ...
            <div>
              ...
              <table class="table table-hover text-center">
                ...
                <tbody>
                  ...
                  $sql = "SELECT t.id, t.id_disponibilidade, t.nome, t.email, t.date 
                  FROM tbl_user_terapeuta t 
                  $where 
                  ORDER BY id DESC 
                  LIMIT $por_pagina  OFFSET $offset";
                  $sql_total = "SELECT COUNT(*) as total FROM tbl_user_terapeuta t $where";
                  ...
                  ?>
                    <tr>
                      <td><span style="color: <?php echo ($row['id_disponibilidade'] == 2) ? '#dc3545' : '#198754'; ?>; font-weight: bold;"><?php echo ($row['id_disponibilidade'] == 2) ? '✘' : '✔'; ?></span></td>
      ...
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title" id="exampleModalLabel" style="font-weight:bold;font-size:140%;">INATIVAR ESTAGIÁRIO</h5>
            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
              <span aria-hidden="true">&times;</span>
            </button>
          </div>
          <div class="modal-body">
            Tem certeza que deseja inativar este estagiário?
