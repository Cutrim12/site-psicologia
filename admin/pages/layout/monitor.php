        ...
        <ul class="sidebar-menu">
          ...
          <li class="treeview active">
            ...
            <ul class="treeview-menu">
              ...
              <li class="active"><a href="../layout/monitor.php"><i class="fa fa-users"></i> Monitores</a></li>
            ...
            <div>
              ...
              <table class="table table-hover text-center">
                ...
                <tbody>
                  ...
                  $sql = "SELECT m.id, m.id_disponibilidade, m.nome, m.email, m.date 
                  FROM tbl_monitor m 
                  $where 
                  ORDER BY id DESC 
                  LIMIT $por_pagina  OFFSET $offset";
                  $sql_total = "SELECT COUNT(*) as total FROM tbl_monitor t $where";
      ...
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title" id="exampleModalLabel" style="font-weight:bold;font-size:140%;">INATIVAR MONITOR</h5>
            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
              <span aria-hidden="true">&times;</span>
            </button>
          </div>
          <div class="modal-body">
            Tem certeza que deseja inativar este monitor?
