...
try {
  ...
  if (isset($_POST["submit"])) {
      ...
      $id_tipo_paciente = $_POST['tipo_paciente'];
      ...
      <section class="sidebar">
        ...
        <ul class="sidebar-menu">
          ...
          <li class="treeview active">
            ...
            <ul class="treeview-menu">
                <li class="active"><a href="pacientes.php"><i class="fa fa-users"></i> Pacientes</a></li>
                <li><a href="professores.php"><i class="fa fa-users"></i> Professores</a></li>
                <li><a href="terapeutas.php"><i class="fa fa-users"></i> Estagiários</a></li>
                <li><a href="monitor.php"><i class="fa fa-users"></i> Monitores</a></li>
          ...
          <div class="box-body">
            ...
            <div class="container">
              ...
              $sql = "SELECT pa.id, pa.nome, pa.nascimento, pa.rg, pa.cpf, pa.id_genero, pa.id_escolaridade, pa.id_renda_familiar, 
                              pa.id_estado_civil, pa.id_endereco, pa.id_tipo_paciente, se.sexo, en.id, en.cep, lo.logradouro, 
                              lo.id AS logradouro_id,
                              es.escolaridade, pr.profissao, pr.id AS profissao_id, re.renda, ec.estado_civil, ba.bairro, 
                              ba.id AS bairro_id, co.telefone_residencial, co.telefone_recado, co.celular, co.email, tp.tipo
                      FROM tbl_paciente AS pa 
                      INNER JOIN tbl_genero se ON se.id = pa.id_genero
                      INNER JOIN tbl_tipo_paciente tp ON pa.id_tipo_paciente = tp.id 
              ...
              <div class="container-fluid divForm">
                <form action="" method="post">
                  ...
                  <select id="tipo_paciente" name="tipo_paciente"  class="form-control custom-input custom-input">
                      <option value="<?php echo $row['id_tipo_paciente']; ?>" selected> <?php echo $row['tipo'] ?> </option>
                      <?php
                          $id_tipo_paciente = $row['id_tipo_paciente'];
                          $sql_tipo_paciente = "SELECT * FROM tbl_tipo_paciente WHERE id !=  $id_tipo_paciente";
                          $result_tipo_paciente = mysqli_query($mysqli, $sql_tipo_paciente);
                          while ($rowTp = mysqli_fetch_assoc($result_tipo_paciente)) {
                      ?>
                              <option value='<?php echo $rowTp['id'] ?>'> <?php echo $rowTp['tipo'] ?> </option>
                      <?php
                          }
                      ?>
                  </select>
