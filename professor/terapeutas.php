                ...
                <tbody>
                  ...
                  ?>
                    <tr>
                      ...
                      <td>
                        <a href="edit/edit-terapeuta.php?id=<?php echo $row["id"] ?>" class="link-dark"><i class="bi bi-pencil-square"></i></a>
                      </td>
                      <td>
                        <a href="pacientes-terapeuta.php?id=<?php echo $row["id"] ?>" class="link-dark"><i class="bi bi-eye-fill"></i></a>
                      </td>
                    </tr>
                  <?php
                  }
