              ...
              <table class="table table-hover text-center">
                <thead class="table-dark">
                  <tr>
                    ...
                    <th scope="col">Gerenciar Consulta</th>
                  </tr>
                </thead>
                <tbody>
                  <?php
                  //$sql = "SELECT * FROM filiais WHERE id_aprovacao = 2";
                  $sql = "SELECT pa.id, pa.nome, pa.cpf, pa.nascimento, c.celular, tp.tipo 
                  ...
                  " . (empty($where) ? 'WHERE pa.ativo = 1' : $where . ' AND pa.ativo = 1') . "
                  ORDER BY pa.id DESC  
                  LIMIT $por_pagina  OFFSET $offset";

                  $sql_total = "SELECT COUNT(*) as total FROM tbl_paciente pa " . (empty($where) ? 'WHERE pa.ativo = 1' : $where . ' AND pa.ativo = 1');
                  ...
                  ?>
                    <tr>
                      ...
                      <td>
                        <a href="gerenciar/gerenciar-paciente-cadastrar.php?id=<?php echo $row["id"] ?>" class="link-dark"><i class="fa fa-plus"></i></a>
