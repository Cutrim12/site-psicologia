...
$id_gerenciamento = $_GET["id"] ?? '';
$id_gerenciamento = trim($id_gerenciamento);

if (isset($_POST["submit"])) {

  $id_estgiario = $_POST['estgiario'];


  $sql = "UPDATE tbl_paciente_terapeuta SET id_terapeuta = $id_estgiario WHERE id = $id_gerenciamento";
  $result = mysqli_query($mysqli, $sql);
  header("Location: ../pacientes-terapeutas.php?msg=Gerenciamento atualizado com sucesso!");

  //header("Location: ../pacientes.php?msg=Error ao atualizar consulta!");
}
?>
              ...
              <div class="box-body">
                ...
                <div class="container">
                  <div class="text-center mb-4">
                    <h3>Gerenciar Consulta do paciente com o estagiário <?php echo $id_gerenciamento ?></h3>
                  </div>
                  <br>
                  <?php
                  $sql = "SELECT p.nome 
                    ...
                    <form action="" method="post">
                      ...
                      <div class="container-fluid">
                        ...
                        <div>
                          ...
                          <a href="../pacientes-terapeutas.php" class="btn btn-danger">Cancelar</a>
                        </div>
                      </div>
                    </form> <br>
