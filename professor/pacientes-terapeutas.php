        ...
        <ul class="sidebar-menu">
          ...
          <li class="treeview active">
            ...
            <ul class="treeview-menu">
              ...
              <li class="active"><a href="pacientes-terapeutas.php"><i class="fa fa-plus-square"></i> Pacientes e Estagiários</a></li>
            </ul>
          </li>
    </aside>
      ...
      <section class="content">
        ...
        <div class="box">
          <div class="box-header with-border">
            ...
            <h3 class="box-title">PACIENTES E TERAPEUTAS</h3>
            ...
            <div>
              <table class="table table-hover text-center">
                ...
                <tbody>
                  ...
                  $sql = "SELECT pt.id AS ptId, pt.id_terapeuta, pt.id_paciente,
                          p.nome AS pacienteNome, t.nome AS terapeutaNome, p.nascimento, sc.status
                          FROM tbl_paciente_terapeuta pt
                          JOIN tbl_paciente p ON p.id = pt.id_paciente
                          JOIN tbl_user_terapeuta t ON t.id = pt.id_terapeuta
                          JOIN tbl_professor pr ON pr.id = t.id_professor
                          JOIN tbl_status_consulta sc ON sc.id = pt.id_status_consulta
                          WHERE pr.id = $id_professor AND pt.id_status_consulta != 2
                          ORDER BY p.nome ASC";
                  ...
                  ?>
                    <tr>
                      ...
                      <td><?php echo $row["terapeutaNome"] ?></td>
                      <td><?php echo $row["status"] ?></td>
                      <td>
                        <a href="gerenciar/gerenciar-paciente-atualizar.php?id=<?php echo $row['ptId'] ?>" class="link-dark"><i class="fa fa-edit"></i></a>
                      </td>
                    </tr>
                  <?php
                  }
