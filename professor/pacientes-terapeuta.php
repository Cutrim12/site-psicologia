...
$id_terapeuta = $_GET['id'] ?? '';
$id_terapeuta = trim($id_terapeuta);
      ...
      <section class="content">
        ...
        <div class="box">
          <div class="box-header with-border">
            ...
            ?>
            <?php
              $sql = "SELECT t.nome AS terapeutaNome FROM tbl_user_terapeuta t WHERE t.id = $id_terapeuta";
              $result = mysqli_query($mysqli, $sql);
              $row = mysqli_fetch_assoc($result);
            ?>
            <h3 class="box-title">PACIENTES DO(A) TERAPEUTA <?php echo  strtoupper($row['terapeutaNome']) ?></h3>
            ...
            <div>
              <table class="table table-hover text-center">
                ...
                <tbody>
                  ...
                  $sql = "SELECT pt.id AS ptId, pt.id_terapeuta, pt.id_paciente, p.nome, p.nascimento, c.celular
                          ...
                          WHERE t.id = $id_terapeuta AND pt.id_status_consulta != 2
                          ORDER BY p.nome ASC";
                  $result = mysqli_query($mysqli, $sql);
