...
if (isset($_POST["submit"])) {
  ...
  $sql = "INSERT INTO `tbl_paciente_terapeuta`(id, id_paciente, id_terapeuta) VALUES (NULL,$id, $id_professor)";
                    ...
                    <form action="" method="post">
                      ...
                      <div class="container-fluid">
                        ...
                        <select class="form-control custom-input" name="estgiario">
                          ...
                          $sql_professor_terapeuta = "SELECT t.nome, t.id AS estagiarioId
                                                      FROM tbl_paciente_terapeuta pt
                                                      INNER JOIN tbl_user_terapeuta t ON t.id = pt.id_terapeuta
                                                      INNER JOIN tbl_paciente p ON p.id = pt.id_paciente
                                                      WHERE pt.id_paciente = $id
                          ...
                          $id_estagiario = $row_professor_terapeuta['estagiarioId'];
                          ?>
                          <option value='<?php echo $id_estagiario ?>'><?php echo $row_professor_terapeuta['nome'] ?></option>
                          <?php
                          $sql_professor = "SELECT t.nome, t.id AS estagiarioId
                                              FROM tbl_user_terapeuta t
                                              INNER JOIN tbl_professor p ON p.id = t.id_professor
                                              WHERE p.id = $id_professor AND t.id_disponibilidade = 1 AND t.id != $id_estagiario";
