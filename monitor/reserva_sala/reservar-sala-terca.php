...
<head>
    ...
    <style>
        * {
        ...
        td.manutencao { background-color: #b02a37; color: #fff; font-weight: bold; cursor: not-allowed; }
    </style>
</head>
<body>
    ...
    <script>
        <?php $resut_sala_cod = mysqli_query($mysqli, "SELECT id, sala_cod FROM tbl_sala_reservada WHERE id_semana = 2"); while($row_sala_cod = mysqli_fetch_assoc($resut_sala_cod)) { ?>
