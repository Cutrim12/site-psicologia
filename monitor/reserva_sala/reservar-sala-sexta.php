...
<body>
    ...
    <script>
        <?php $resut_sala_cod = mysqli_query($mysqli, "SELECT id, sala_cod FROM tbl_sala_reservada WHERE id_semana = 5"); while($row_sala_cod = mysqli_fetch_assoc($resut_sala_cod)) { ?>
