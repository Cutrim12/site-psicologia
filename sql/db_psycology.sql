...
--
-- Host: 127.0.0.1
-- Tempo de geração: 17/02/2026 às 21:31
...
(4, 'roberto@gmail.com', '4587233', '4587233', '(91)91458-9126'),
(5, 'larissa@gmail.com', '44354423424', '3432432432', '88918021221');
...
(2, 1, 'robson', 'robson', 'robson@gmail.com', '$2y$10$xrTothzpWwcQA7p3ySwfme2k/M/8nrlZ54c5W8AR9IRn6uk9J7bXi', '2025-04-01 01:00:25');

-- --------------------------------------------------------

--
-- Estrutura para tabela `tbl_tipo_paciente`
--
...
INSERT INTO `tbl_tipo_paciente` (`id`, `tipo`) VALUES
(1, 'Adulto'),
(2, 'Criança');
...
CREATE TABLE `tbl_paciente` (
  ...
  `id_tipo_paciente` int(11) UNSIGNED NOT NULL DEFAULT 1,
...
INSERT INTO `tbl_paciente` (`id`, `nome`, `nascimento`, `rg`, `cpf`, `id_genero`, `id_contato`, `id_escolaridade`, `id_profissao`, `id_renda_familiar`, `id_estado_civil`, `id_endereco`, `id_maturidade`, `nome_responsavel`, `id_tipo_paciente`, `ativo`) VALUES
(4, 'Roberto Murilo Viana', '1990-12-02', 45646546, 2147483647, 1, 4, 7, 4, 3, 2, 4, 1, '', 1, 1),
(5, 'Larissa Lemos Pinheiro', '1992-12-08', 45642226, 2147483647, 2, 5, 7, 5, 3, 2, 5, 1, '', 1, 1);

-- --------------------------------------------------------

--
-- Estrutura para tabela `tbl_paciente_terapeuta`
--

CREATE TABLE `tbl_paciente_terapeuta` (
  `id` int(11) NOT NULL,
  `id_paciente` int(11) UNSIGNED NOT NULL,
  `id_terapeuta` int(11) NOT NULL,
  `id_status_consulta` int(11) NOT NULL,
  `registro` timestamp NOT NULL DEFAULT current_timestamp()
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

--
-- Despejando dados para a tabela `tbl_paciente_terapeuta`
--

INSERT INTO `tbl_paciente_terapeuta` (`id`, `id_paciente`, `id_terapeuta`, `id_status_consulta`, `registro`) VALUES
(38, 5, 3, 2, '2026-01-31 22:25:47'),
(39, 4, 5, 3, '2026-01-31 22:26:05');
...
(2, 1, 'Carlos', 'Carlos', 'carlos@gmail.com', '$2y$10$ocD09sTmwU3pXsDZqxfZeeG1PF8m9gojYFlqwtwaSxpo4TIaxQ4YG', '2025-04-03 00:53:49'),
(3, 1, 'Ronaldo', 'Ronaldo', 'ronaldo@gmail.com', '$2y$10$nBjXwA5W3cObX3FRm4fFM.yFHKfm6oUy.pxaAg7T.j2Tc/UG6npGK', '2025-04-03 11:43:09');
...
(3, 1, 1, 1, 4, NULL, NULL, 'seg_m_8_s1', 'Ana - Rafael'),
(4, 1, 1, 1, 2, 3, 5, 'seg_m_8_s2', 'Ana - Larissa Lemos Pinheiro'),
(5, 1, 1, 1, 1, 3, 5, 'seg_m_8_s2', 'Ana - Larissa Lemos Pinheiro'),
(6, 1, 1, 1, 4, 3, 4, 'seg_m_8_s1', 'Ana - Roberto Murilo Viana'),
(7, 1, 1, 1, 4, 6, 4, 'seg_m_8_s1', 'Jorge - Roberto Murilo Viana'),
(8, 1, 1, 1, 4, 4, 4, 'seg_m_8_s1', 'Júlia - Roberto Murilo Viana'),
(9, 1, 3, 1, 2, 6, 4, 'seg_m_10_s2', 'Jorge - Roberto Murilo Viana'),
(10, 1, 3, 1, 6, 6, 4, 'seg_m_10_s2', 'Jorge - Roberto Murilo Viana'),
(11, 1, 3, 1, 1, 6, 4, 'seg_m_10_s2', 'Jorge - Roberto Murilo Viana'),
(12, 1, 3, 1, 6, 6, 4, 'seg_m_10_s2', 'Jorge - Roberto Murilo Viana'),
(13, 1, 3, 1, 7, 6, 4, 'seg_m_10_s2', 'Jorge - Roberto Murilo Viana'),
(14, 1, 3, 1, 6, 6, 4, 'seg_m_10_s2', 'Jorge - Roberto Murilo Viana'),
(15, 1, 2, 1, 4, 5, 5, 'seg_m_9_s6', 'Luís - Larissa Lemos Pinheiro'),
(16, 1, 2, 1, 2, 4, 5, 'seg_m_9_s6', 'Júlia - Larissa Lemos Pinheiro'),
(17, 1, 2, 1, 7, 4, 5, 'seg_m_9_s6', 'Júlia - Larissa Lemos Pinheiro'),
(18, 1, 2, 1, 7, 4, 4, 'seg_m_9_s6', 'Júlia - Roberto Murilo Viana'),
(19, 1, 3, 1, 2, 3, 4, 'seg_m_10_s5', 'Ana - Roberto Murilo Viana'),
(20, 1, 3, 1, 4, 3, 4, 'seg_m_10_s5', 'Ana - Roberto Murilo Viana'),
(21, 1, 3, 1, 4, 3, 5, 'seg_m_10_s5', 'Ana - Larissa Lemos Pinheiro'),
(22, 1, 3, 1, 4, 5, 5, 'seg_m_10_s5', 'Luís - Larissa Lemos Pinheiro'),
(23, 1, 3, 1, 6, 5, 5, 'seg_m_10_s5', 'Luís - Larissa Lemos Pinheiro'),
(24, 1, 2, 1, 2, 6, 5, 'seg_m_9_s2', 'Jorge - Larissa Lemos Pinheiro'),
(25, 1, 2, 1, 1, 6, 5, 'seg_m_9_s2', 'Jorge - Larissa Lemos Pinheiro'),
(26, 1, 2, 1, 6, 4, 5, 'seg_m_9_s5', 'Júlia - Larissa Lemos Pinheiro'),
(27, 1, 2, 1, 6, 6, 5, 'seg_m_9_s5', 'Jorge - Larissa Lemos Pinheiro'),
(28, 1, 2, 1, 6, 6, 4, 'seg_m_9_s5', 'Jorge - Roberto Murilo Viana'),
(29, 1, 1, 1, 2, 6, 5, 'seg_m_8_s1', 'Jorge - Larissa Lemos Pinheiro'),
(30, 1, 1, 1, 3, 6, 5, 'seg_m_8_s1', 'Jorge - Larissa Lemos Pinheiro'),
(31, 1, 3, 1, 2, 3, 4, 'seg_m_10_s3', 'Ana - Roberto Murilo Viana'),
(32, 1, 3, 1, 6, 3, 4, 'seg_m_10_s3', 'Ana - Roberto Murilo Viana'),
(33, 1, 2, 1, 2, 6, 5, 'seg_m_9_s5', 'Jorge - Larissa Lemos Pinheiro'),
(34, 1, 2, 1, 3, 6, 5, 'seg_m_9_s5', 'Jorge - Larissa Lemos Pinheiro'),
(35, 1, 1, 1, 2, 3, 4, 'seg_m_8_s1', 'Ana - Roberto Murilo Viana'),
(36, 1, 1, 1, 4, 3, 4, 'seg_m_8_s1', 'Ana - Roberto Murilo Viana'),
(37, 1, 1, 1, 4, 3, 5, 'seg_m_8_s1', 'Ana - Larissa Lemos Pinheiro'),
(38, 1, 1, 1, 4, 3, 4, 'seg_m_8_s1', 'Ana - Roberto Murilo Viana'),
(39, 1, 1, 1, 4, 3, 4, 'seg_m_8_s1', 'Ana - Roberto Murilo Viana'),
(40, 1, 1, 1, 6, 3, 4, 'seg_m_8_s1', 'Ana - Roberto Murilo Viana'),
(41, 1, 1, 1, 2, 3, 5, 'seg_m_8_s1', 'Ana - Larissa Lemos Pinheiro'),
(42, 1, 1, 1, 1, 3, 5, 'seg_m_8_s1', 'Ana - Larissa Lemos Pinheiro'),
(43, 1, 1, 1, 2, 3, 5, 'seg_m_8_s1', 'Ana - Larissa Lemos Pinheiro'),
(44, 1, 1, 1, 2, 3, 5, 'seg_m_8_s1', 'Ana - Larissa Lemos Pinheiro'),
(45, 1, 1, 1, 1, 3, 5, 'seg_m_8_s1', 'Ana - Larissa Lemos Pinheiro'),
(46, 1, 1, 1, 2, 3, 5, 'seg_m_8_s1', 'Ana - Larissa Lemos Pinheiro'),
(47, 1, 1, 1, 2, 3, 5, 'seg_m_8_s1', 'Ana - Larissa Lemos Pinheiro'),
(48, 1, 1, 1, 2, 3, 5, 'seg_m_8_s1', 'Ana - Larissa Lemos Pinheiro'),
(49, 1, 1, 1, 2, 3, 5, 'seg_m_8_s1', 'Ana - Larissa Lemos Pinheiro'),
(50, 1, 1, 1, 2, 3, 5, 'seg_m_8_s1', 'Ana - Larissa Lemos Pinheiro'),
(51, 1, 1, 1, 2, 3, 5, 'seg_m_8_s1', 'Ana - Larissa Lemos Pinheiro'),
(52, 1, 1, 1, 2, 3, 5, 'seg_m_8_s1', 'Ana - Larissa Lemos Pinheiro'),
(53, 1, 1, 1, 2, 3, 5, 'seg_m_8_s1', 'Ana - Larissa Lemos Pinheiro'),
(54, 1, 1, 1, 2, 3, 5, 'seg_m_8_s1', 'Ana - Larissa Lemos Pinheiro'),
(55, 1, 1, 1, 2, 3, 5, 'seg_m_8_s1', 'Ana - Larissa Lemos Pinheiro'),
(56, 1, 1, 1, 2, 3, 5, 'seg_m_8_s1', 'Ana - Larissa Lemos Pinheiro'),
(57, 1, 1, 1, 2, 3, 5, 'seg_m_8_s1', 'Ana - Larissa Lemos Pinheiro'),
(58, 1, 1, 1, 2, 3, 5, 'seg_m_8_s1', 'Ana - Larissa Lemos Pinheiro'),
(59, 1, 1, 1, 2, 3, 5, 'seg_m_8_s1', 'Ana - Larissa Lemos Pinheiro');
...
--
-- Estrutura para tabela `tbl_status_consulta`
--
...
--
-- Despejando dados para a tabela `tbl_status_consulta`
--

INSERT INTO `tbl_status_consulta` (`id`, `status`) VALUES
(1, 'agendado'),
(2, 'finalizada'),
(3, 'aguardando consulta');
...
(3, 1, 2, 'Ana', 'Ana', 'ana@gmail.com', '$2y$10$ZgaYItv.LweueJro4GB1meMx3zdpeEY2DWtvdJt6GgofaoFFOFXdW', '2025-04-03 00:52:37'),
(4, 1, 3, 'Júlia', 'Júlia', 'julia@gmail.com', '$2y$10$Z8KOyBoIxfe.6WHvHip9HuX8BqV3bNc4Dsayb9/56xF7ZcG05iFX2', '2025-04-03 11:43:27'),
(5, 1, 2, 'Luís', 'Luís', 'luis@gmail.com', '$2y$10$HJmDuqLNXdTYNtbzhEJ5oeAt9m4x82ZqYZHZyfQkIO97CVlkwtiFi', '2025-04-03 13:10:05'),
(6, 1, 3, 'Jorge', 'Jorge', 'jorge@gmail.com', '$2y$10$eQ/qYQOOaEEbZ74YDI1dj.S0E5OlPPb0BWBSzp73mT.FHC0R3LeJO', '2025-04-03 13:10:48');
...
ALTER TABLE `tbl_paciente`
  ...
  ADD KEY `fk_paciente_tipo` (`id_tipo_paciente`);

--
-- Índices de tabela `tbl_paciente_terapeuta`
--
ALTER TABLE `tbl_paciente_terapeuta`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_pt_paciente` (`id_paciente`),
  ADD KEY `fk_pt_terapeuta` (`id_terapeuta`),
  ADD KEY `fk_pt_status_consulta` (`id_status_consulta`);
...
--
-- Índices de tabela `tbl_status_consulta`
--
ALTER TABLE `tbl_status_consulta`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT de tabela `tbl_paciente_terapeuta`
--
ALTER TABLE `tbl_paciente_terapeuta`
...
--
-- AUTO_INCREMENT de tabela `tbl_status_consulta`
--
ALTER TABLE `tbl_status_consulta`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
...
ALTER TABLE `tbl_paciente`
  ...
  ADD CONSTRAINT `fk_paciente_tipo` FOREIGN KEY (`id_tipo_paciente`) REFERENCES `tbl_tipo_paciente` (`id`);

--
-- Restrições para tabelas `tbl_paciente_terapeuta`
--
ALTER TABLE `tbl_paciente_terapeuta`
  ADD CONSTRAINT `fk_pt_paciente` FOREIGN KEY (`id_paciente`) REFERENCES `tbl_paciente` (`id`),
  ADD CONSTRAINT `fk_pt_status_consulta` FOREIGN KEY (`id_status_consulta`) REFERENCES `tbl_status_consulta` (`id`),
  ADD CONSTRAINT `fk_pt_terapeuta` FOREIGN KEY (`id_terapeuta`) REFERENCES `tbl_user_terapeuta` (`id`);
